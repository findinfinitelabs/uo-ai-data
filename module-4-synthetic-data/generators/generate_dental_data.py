...
PROCEDURES = [
    ...
    {'code': 'D0210', 'description': 'Intraoral complete series of radiographic images', 'cost': 150},
...
TOOTH_CONDITIONS = [
    ...
    'implant', 'missing', 'root_canal', 'crack', 'chip'
]
...
def generate_imaging():
    ...
    if random.random() < 0.5:
        ...
        images.append({
            ...
            'findings': random.choice(['No cavities detected', 'Interproximal caries on #14', 'Normal'])
        })
...
def generate_dental_visit():
    ...
    if random.random() < 0.8:
        ...
        next_apt = {
            'recommended_date': (datetime.now() + timedelta(days=days_forward)).strftime('%Y-%m-%d'),
...
def main():
    ...
    with open(csv_file, 'w', newline='') as f:
        fieldnames = [
            ...
            'chief_complaint', 'num_teeth_issues', 'psr_code',
            'bleeding_on_probing', 'oral_hygiene_index',
            'num_treatments_planned', 'num_procedures_performed',
            'num_images', 'next_appointment_scheduled'
        ]
        ...
        for visit in visits:
            row = {
                ...
                'bleeding_on_probing': visit['examination']['periodontal_screening']['bleeding_on_probing'],
